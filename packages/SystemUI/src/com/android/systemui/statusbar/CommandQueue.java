...
public class CommandQueue extends IStatusBar.Stub implements
    ...
    private static final int MSG_SCREEN_PINNING_STATE_CHANGED = 100 << MSG_SHIFT;
    private static final int MSG_LEFT_IN_LANDSCAPE_STATE_CHANGED = 101 << MSG_SHIFT;
    private static final int MSG_SET_BLOCKED_GESTURAL_NAVIGATION = 102 << MSG_SHIFT;
